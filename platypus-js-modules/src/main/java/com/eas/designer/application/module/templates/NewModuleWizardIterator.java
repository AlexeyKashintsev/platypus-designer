...
public class NewModuleWizardIterator extends NewApplicationElementWizardIterator {
    ...
    @TemplateRegistrations({
        ...
        @TemplateRegistration(
                ...
                displayName = "#Templates/Other/PlatypusAMDPureModuleTemplate",
                description = "AmdPureModule.html",
                scriptEngine = "freemarker"),
        @TemplateRegistration(
                folder = "Platypus.js",
                position = 300,
        ...
        @TemplateRegistration(
                ...
                position = 200,
                content = {"PlatypusPureModuleTemplate.js"},
                displayName = "#Templates/Other/PlatypusPureModuleTemplate",
                description = "PureModule.html",
                scriptEngine = "freemarker"),
        @TemplateRegistration(
                folder = "Platypus.js/Global modules",
                position = 300,

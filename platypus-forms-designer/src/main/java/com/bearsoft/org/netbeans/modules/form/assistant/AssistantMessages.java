 ...
 */
package com.bearsoft.org.netbeans.modules.form.assistant;
...
public class AssistantMessages {
    ...
    private void initialize() {
        Map<String, Set<String>> contextToSet = new HashMap<>();
        ...
        for (Map.Entry<String, Set<String>> entry : contextToSet.entrySet()) {

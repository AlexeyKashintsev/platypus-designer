 ...
 * @author mg
 */
@ProjectCustomizer.CompositeCategoryProvider.Registration(category = "platypusClient", categoryLabel = "#platypusClient", projectType = "org-netbeans-modules-platypus", position = 13)

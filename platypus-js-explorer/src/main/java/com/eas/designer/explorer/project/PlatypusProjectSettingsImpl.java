...
public class PlatypusProjectSettingsImpl implements PlatypusProjectSettings {
    ...
    public String getDefaultDataSourceName() {
        return projectProperties.get(DEFAULT_DATA_SOURCE_ELEMENT_KEY);
    }
    ...
    public void setDefaultDatasourceName(String aValue) {
        ...
        if (aValue != null) {
            projectProperties.setProperty(DEFAULT_DATA_SOURCE_ELEMENT_KEY, aValue);
        } else {
            projectProperties.remove(DEFAULT_DATA_SOURCE_ELEMENT_KEY);
        }
        projectPropertiesDirty = true;
